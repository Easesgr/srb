...
public class HfbConst {
    ...
    //用户绑定异步回调
    public static final String USERBIND_NOTIFY_URL = "http://localhost:8888/srb/front/userBind/notify";
    //用户绑定同步回调
    ...
    //充值异步回调
    public static final String RECHARGE_NOTIFY_URL = "http://localhost:8888/srb/front/account/notify";
    //充值同步回调
    ...
    //充值异步回调
    public static final String INVEST_NOTIFY_URL = "http://localhost:8888/srb/front/lendItem/notify";
    //充值同步回调
    ...
    //充值异步回调
    public static final String WITHDRAW_NOTIFY_URL = "http://localhost:8888/srb/front/account/notifyWithdraw";
    //充值同步回调
    ...
    //充值异步回调
    public static final String BORROW_RETURN_NOTIFY_URL = "http://localhost:8888/srb/front/lendReturn/notifyUrl";
    //充值同步回调
