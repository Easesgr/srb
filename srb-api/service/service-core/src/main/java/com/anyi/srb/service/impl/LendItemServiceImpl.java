...
import com.anyi.srb.mapper.LendItemMapper;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public String commitInvest(InvestVO investVO) {
        ...
        BigDecimal amount = userAccountService.getCount(investUserId);//获取当前用户的账户余额
        if (!(amount.doubleValue() >= Double.parseDouble(investVO.getInvestAmount()))){
    ...
    public List<LendItem> selectByLendId(Long lendId) {
        List<LendItem> list = list(new LambdaQueryWrapper<LendItem>().eq(LendItem::getLendId, lendId));
        return list;
    }
