      ...
      <el-form>
        <el-form-item label="请选择Excel文件">
          <el-upload
            ...
            :action="BASE_API + '/srb/admin/dict/import'"
            name="file"
...
export default {
  ...
  methods: {
    ...
    exportData() {
      window.location.href = this.BASE_API + "/srb/admin/dict/export";
    },
    // 懒加载数据
    load(tree, treeNode, resolve) {
      dict.getByparentId(tree.id).then((response) => {
        //负责将子节点数据展示在展开的列表中
